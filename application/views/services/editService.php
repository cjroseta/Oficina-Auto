    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card bg-light">
                ...
                <form action="<?php echo current_url(); ?>" id="formService" method="post" class="form-horizontal p-t-5">
                    <div class="form-body">
                        <div class="card-body pb-0">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <?php echo form_hidden('idService', $result->idService) ?>
                                        <label for="name_service" class="control-label text-right col-md-3">Nome<span class="required text-danger">*</span></label>
                                        <div class="col-md-9">
                                            <input type="text" id="name_service" class="form-control" name="name_service" value="<?php echo $result->name_service; ?>" />
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
                                <div class="col-md-6">
                                    <div class="form-group has-danger row">
                                        ...
                                        <div class="col-md-9">
                                            <input id="unit_price" type="text" name="unit_price" value="<?php echo $result->unit_price; ?>" class="form-control form-control-danger" />
                                        </div>
                                    </div>
                                </div>
                                <!--/span-->
