        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse  first-level">
                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vContact')) { ?>
                            <li class="sidebar-item">
                                <a href="<?= site_url('contacts') ?>" class="sidebar-link <?php if (isset($menuContacts)) {
                                                                                                echo 'active';
                                                                                            } ?>">
                        ...
                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vProduct')) { ?>
                            <li class="sidebar-item">
                                <a href="<?= site_url('products') ?>" class="sidebar-link <?php if (isset($menuProducts)) {
                                                                                                echo 'active';
                                                                                            } ?>">
                        ...
                        <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vViatura')) { ?>
                            <li class="sidebar-item">
                                <a href="<?= site_url('viaturas') ?>" class="sidebar-link <?php if (isset($menuViaturas)) {
                                                                                                echo 'active';
                                                                                            } ?>">
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vQuotation')) { ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if (isset($menuQuotation)) {
                                                                                        echo 'active';
                                                                                    } ?>" href="<?= site_url('quotation') ?>" aria-expanded="false">
                ...
                <!-- Purchases -->
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vPurchase')) { ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link has-arrow waves-effect waves-dark sidebar-link <?php if (isset($menuPurchases)) {
                                                                                                    echo 'active';
                                                                                                } ?>" href="<?= site_url('purchases') ?>" aria-expanded="false">
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a class="sidebar-link" <?php if (isset($menuPurchase)) {
                                                            echo 'active';
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vJc')) { ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if (isset($menuJobcards)) {
                                                                                        echo 'active';
                                                                                    } ?>" href="<?= site_url('jobCards') ?>" aria-expanded="false">
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vJc')) { ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if (isset($menuJobcards)) {
                                                                                        echo 'active';
                                                                                    } ?>" href="<?= site_url('contratos') ?>" aria-expanded="false">
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vVenda')) { ?>
                    <li class="sidebar-item">
                        <a class="sidebar-link waves-effect waves-dark sidebar-link <?php if (isset($menuVendas)) {
                                                                                        echo 'active';
                                                                                    } ?>" href="<?= site_url('vendas') ?>" aria-expanded="false">
                ...
                <?php if ($this->permission->checkPermission($this->session->userdata('permissao'), 'vLancamento')) { ?>
                    <li class="sidebar-item">
                        ...
                        <ul aria-expanded="false" class="collapse  first-level">
                            <li class="sidebar-item">
                                <a class="sidebar-link" <?php if (isset($menuLancamentos)) {
                                                            echo 'active';
                                                        } ?>" href="<?= site_url('jobCards') ?>">
                                    <i class="mdi mdi-adjust"></i>
