                            ...
                            <?php
                                ...
                                foreach ($results as $r) {
                                    ...
                                    echo '<td class="text-center">';
                                        echo '<a href="' . base_url() . 'index.php/marcas/editar/' . $r->idMarca . '" style="margin-right: 2%" class="btn btn-xs btn-icon btn-info btn-outline" data-toggle="tooltip" data-original-title="Editar"><i class="ti-pencil-alt"></i></a>';
