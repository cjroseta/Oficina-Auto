        ...
        <div class="col-lg-12 col-xlg-9 col-md-7">
            <div class="card pt-4 pl-0 pb-4">
                <div class="col-sm-12 mb-3">
                    ...
                    <a href="<?php echo base_url(); ?>index.php/marcas/adicionar" class="btn btn-success p-0-0">
                        <span class="button__icon"><i class="mdi mdi-plus-circle-outline"></i></span><span class="button__text2">Adicionar Marca</span>
                    </a>
                    <?php } ?>
                </div>
                            ...
                            <?php
                                ...
                                foreach ($results as $r) {
                                    ...
                                    echo '<td class="text-center">';
                                        echo '<a href="' . base_url() . 'index.php/servicos/visualizar/' . $r->idMarca . '" style="margin-right: 2%" class="btn btn-xs btn-icon btn-success btn-outline" data-toggle="tooltip" data-original-title="Ver mais detalhes"><i class="ti-eye"></i></a>';

                                        echo '<a href="' . base_url() . 'index.php/servicos/editar/' . $r->idMarca . '" style="margin-right: 2%" class="btn btn-xs btn-icon btn-info btn-outline" data-toggle="tooltip" data-original-title="Editar"><i class="ti-pencil-alt"></i></a>';
