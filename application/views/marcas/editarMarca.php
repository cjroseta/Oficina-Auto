                    ...
                    <div class="form-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <?php echo form_hidden('idMarca', $result->idMarca) ?>
                        ...
                        <div class="form-actions">
                            <div class="text-center p-25">
                                ...
                                <a class="btn btn-danger waves-effect waves-light p-0-0" href="<?php echo site_url() ?>/marcas"><span class="button__icon"><i class="mdi mdi-reply-all"></i></span><span class="button__text2 p-r-20">Cancelar</span></a>
                            </div>
                        </div>
                        <!-- End Form Action -->
                    </div>
