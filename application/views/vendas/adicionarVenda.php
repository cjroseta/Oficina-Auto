                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="nuit" class="col-form-label text-right col-md-3">NUIT<span class="required text-danger">*</span></label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group has-danger row">
                                        <label for="nomeCliente" class="control-label text-right col-md-3">Nome<span class="required text-danger">*</span></label>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $('#formCliente').validate({
            rules: { nuit: {required: true}, nomeCliente: {required: true}, },
            messages: { nuit: {required: 'Campo Obrigatório.'}, nomeCliente: {required: 'Campo Obrigatório.'}, },
