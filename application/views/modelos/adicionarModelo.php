        ...
        <div class="col-lg-12">
            <div class="card bg-light">
                <div class="card-header bg-transparent">
                    <h3 class="card-title">Cadastro de Modelos</h3>
                </div>
                <hr class="m-0-0">
                <?php if ($custom_error != '') {
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-actions">
                            <div class="text-center p-25">
                                ...
                                <a class="btn btn-danger waves-effect waves-light p-0-0" href="<?php echo site_url() ?>/modelos"><span class="button__icon"><i class="mdi mdi-reply-all"></i></span><span class="button__text2 p-r-20">Cancelar</span></a>
                            </div>
                        </div>
                        <!-- End Form Action -->
                    </div>
