                    ...
                    <div class="form-body">
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        <label for="fotos" class="control-label text-right col-md-3">Fotos da Viatura</label>
                                        <div class="col-md-9">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $("#viaMatricula").focus();
        $('#formViatura').validate({
            rules: { viaMatricula: {required: true}, clientes_id: {required: true}, },
            messages: { viaMatricula: {required: 'Campo Obrigatório.'}, clientes_id: {required: 'Campo Obrigatório.'}, },
